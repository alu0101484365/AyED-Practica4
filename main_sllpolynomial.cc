...
int main()
{
  ...
  // MODIFICACION
  cout << endl;
  cout << "Suma coeficientes sllp1 = " << sllp1.suma_coef() << endl;
  cout << "Suma coeficiente sllp2 = " << sllp2.suma_coef() << endl;
  cout << "Suma coeficiente sllp3 = " << sllp3.suma_coef() << endl << endl;
  return 0;
}
